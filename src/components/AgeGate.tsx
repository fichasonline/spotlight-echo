...
export function AgeGate({ children }: { children: ReactNode }) {
  ...
  if (!verified) {
    return (
      <div className="age-gate-backdrop fixed inset-0 z-[100] flex items-center justify-center bg-background/95 backdrop-blur-sm">
        <div className="age-gate-panel bg-card border border-border rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-2xl">
