...
export default function SorteoTv() {
  return (
    <main className="min-h-screen bg-[#f7f3fb] text-foreground dark:bg-background">
      ...
      <section className="relative overflow-hidden border-b border-primary/20">
        ...
        <div className="container mx-auto grid min-h-[calc(100vh-4rem)] items-center gap-10 px-4 py-12 md:grid-cols-[1fr_0.88fr] md:py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-balance text-5xl font-black leading-[0.95] text-brand-light sm:text-6xl lg:text-7xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button
                asChild
                size="lg"
                className="h-12 rounded-full bg-brand-light px-6 text-base font-black text-[#160b22] hover:bg-brand-light/90"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 rounded-full border-brand-light/35 bg-brand-light/8 px-6 text-base font-bold text-brand-light hover:bg-brand-light/14 hover:text-brand-light"
              >
            ...
            <div className="mt-9 grid gap-3 sm:grid-cols-3">
              <div className="rounded-lg border border-brand-light/15 bg-black/28 p-4 backdrop-blur">
                <Tv className="mb-3 h-6 w-6 text-amber-200" />
                <p className="text-sm font-semibold text-brand-light/58">Premio</p>
                <p className="mt-1 text-xl font-black text-brand-light">1 TV 65&quot; 4K</p>
              </div>
              <div className="rounded-lg border border-brand-light/15 bg-black/28 p-4 backdrop-blur">
                <Sparkles className="mb-3 h-6 w-6 text-amber-200" />
                <p className="text-sm font-semibold text-brand-light/58">Participación</p>
                <p className="mt-1 text-xl font-black text-brand-light">Gratis</p>
              </div>
              <div className="rounded-lg border border-brand-light/15 bg-black/28 p-4 backdrop-blur">
                <CalendarClock className="mb-3 h-6 w-6 text-amber-200" />
                <p className="text-sm font-semibold text-brand-light/58">Cierre</p>
                <p className="mt-1 text-xl font-black text-brand-light">10/06/2026 · 18:00</p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[2rem] border border-brand-light/18 bg-[#08050d]/82 p-5 shadow-[0_30px_90px_hsl(0_0%_0%_/_0.48)] backdrop-blur-xl">
              <div className="rounded-[1.35rem] border border-brand-light/10 bg-gradient-to-b from-[#251131] to-[#09060d] p-5">
                ...
                <div className="mt-8 aspect-video rounded-2xl border border-amber-200/35 bg-[linear-gradient(135deg,#1c0c2a,#101010_45%,#33290d)] p-4 shadow-[inset_0_0_45px_hsl(273_66%_66%_/_0.22)]">
                  <div className="flex h-full flex-col items-center justify-center rounded-xl border border-brand-light/10 bg-black/30 text-center">
                    <Tv className="h-16 w-16 text-amber-200" />
                    <p className="mt-4 text-4xl font-black text-brand-light">65&quot; 4K</p>
                    <p className="mt-1 text-sm font-bold uppercase tracking-[0.22em] text-brand-light/56">
                      Mundial + WSOP
                    </p>
                  </div>
                </div>

                <p className="mt-6 text-xl font-black leading-tight text-brand-light">
                  Imaginate la final del Mundial en una pantalla gigante 4K.
                </p>
                <p className="mt-3 text-brand-light/65">¿Con quién te la bancarías?</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {steps.map((step, index) => {
              ...
              return (
                <article
                  key={step.title}
                  className="rounded-lg border border-border bg-brand-light p-6 shadow-[0_14px_34px_hsl(273_30%_25%_/_0.09)] dark:bg-background/68 dark:shadow-card"
                >
      ...
      <section className="bg-brand-light dark:bg-background">
        <div className="container mx-auto grid gap-6 px-4 py-12 md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-lg border border-border bg-brand-light p-6 shadow-[0_14px_34px_hsl(273_30%_25%_/_0.08)] dark:bg-card dark:shadow-none">
